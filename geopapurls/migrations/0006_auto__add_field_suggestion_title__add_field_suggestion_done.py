...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Suggestion.title'
        db.add_column(u'geopapurls_suggestion', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Suggestion.done'
        db.add_column(u'geopapurls_suggestion', 'done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Suggestion.title'
        db.delete_column(u'geopapurls_suggestion', 'title')

        # Deleting field 'Suggestion.done'
        db.delete_column(u'geopapurls_suggestion', 'done')
